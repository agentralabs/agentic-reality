//! Conservation tests for AgenticReality.
//!
...
use agentic_reality::cache::LruCache;
use agentic_reality::metrics::tokens::{Layer, TokenMetrics};
use agentic_reality::query::budget::TokenBudget;
use agentic_reality::query::intent::ExtractionIntent;
