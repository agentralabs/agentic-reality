...
pub struct CacheMetrics { hits: AtomicU64, misses: AtomicU64, evictions: AtomicU64, current_size: AtomicUsize }
impl CacheMetrics {
    pub fn new() -> Self { Self { hits: AtomicU64::new(0), misses: AtomicU64::new(0), evictions: AtomicU64::new(0), current_size: AtomicUsize::new(0) } }
...
impl Default for CacheMetrics { fn default() -> Self { Self::new() } }
